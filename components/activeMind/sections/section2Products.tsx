            ...
            <div className="flex flex-col lg:flex-row lg:items-start lg:justify-end gap-4">
              ...
              <div className="flex flex-row gap-2">
                ...
                <div
                  ...
                  className={`
                    group flex items-center gap-2.5 px-3 py-2 rounded-xl border
                    transition-all duration-150 cursor-pointer min-w-max
                    ${editingPrice?.id === service.id && editingPrice?.field === "monthly"
                      ? "bg-white border-blue-300 ring-2 ring-blue-50 shadow-inner" 
                      : "bg-white/50 border-blue-300 hover:border-blue-300 hover:bg-white hover:shadow-sm"
                    }
                  `}
                >
                  <div className="flex-shrink-0 p-1.5 rounded-lg bg-white border border-gray-100 group-hover:border-blue-100 transition-colors">
                    <Calendar className="w-4 h-4 text-blue-500" />
                  </div>

                  <div className="flex flex-col min-w-[60px]">
                    <span className="text-[10px] font-bold text-gray-500 uppercase tracking-wide leading-none mb-1">
                      Mensile
                    </span>
                    {editingPrice?.id === service.id && editingPrice?.field === "monthly" ? (
                      <div className="flex items-center gap-1">
                        <span className="text-xs font-semibold text-gray-800">CHF</span>
                        <Input
                          type="number"
                          min="0"
                          step="1"
                          className="w-16 h-5 px-1 py-0 bg-white text-black border border-blue-300 rounded focus:ring-1 focus:ring-blue-400 text-sm inline text-left font-semibold"
                          autoFocus
                      ...
                      <div className="flex items-baseline gap-1 whitespace-nowrap">
                        <span className="text-xs font-semibold text-gray-700">CHF</span>
                ...
                <div
                  ...
                  className={`
                    ...
                    ${editingPrice?.id === service.id && editingPrice?.field === "yearly"
                      ? "bg-white border-blue-300 ring-2 ring-blue-50 shadow-inner" 
                      : "bg-white/70 border-blue-300 hover:border-blue-300 hover:bg-white hover:shadow-sm"
                    }
                  `}
                >
                  <div className="flex-shrink-0 p-1.5 rounded-lg bg-white border border-gray-100 group-hover:border-blue-100 transition-colors">
