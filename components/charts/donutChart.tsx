...
export default function DonutChart({ dashboardBlockId, blockId, gridReady }: PropsInterface) {
    ...
    const chartData = {
        series: responseData.values.map((value) => parseFloat(value)),
        options: {
          labels: responseDataDEV.labels,
          title: {
